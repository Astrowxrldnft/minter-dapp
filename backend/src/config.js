...
const ROYALTY_ADDRESS = "0x5E4aBF6F2C78463C38B264662803CE45e331d73E"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = ["0x5E4aBF6F2C78463C38B264662803CE45e331d73E"]; // only update if you want to manually set the whitelisted addresses
